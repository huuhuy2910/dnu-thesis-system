...
const mockLecturers: Lecturer[] = [
  { id: '1', name: 'TS. Nguyễn Văn Hòa', degree: 'Tiến sĩ', specialty: 'Trí tuệ nhân tạo' },
  { id: '2', name: 'TS. Trần Minh Hòa', degree: 'Tiến sĩ', specialty: 'Cơ sở dữ liệu' },
  { id: '3', name: 'ThS. Trần Thu Hằng', degree: 'Thạc sĩ', specialty: 'Mạng máy tính' },
  { id: '4', name: 'ThS. Nguyễn Thu Hà', degree: 'Thạc sĩ', specialty: 'Khoa học dữ liệu' },
  { id: '5', name: 'ThS. Phạm Anh Dũng', degree: 'Thạc sĩ', specialty: 'Lập trình' },
...
const CommitteesManagement: React.FC = () => {
  ...
  const handleCreateCommittee = () => {
    if (!newCommittee.topic || !newCommittee.student || !newCommittee.chairman || !newCommittee.secretary || !newCommittee.member) {
  ...
  const otherLecturers = mockLecturers.filter(l => l.degree !== 'Tiến sĩ' || chairmanOptions.some(c => c.id !== l.id));

  return (
    <div className="admin-dashboard">
      <div className="dashboard-header">
        <h1>
          <ShieldCheck size={32} style={{ marginRight: 12, color: '#f37021' }} />
      ...
      <div style={{ marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ fontSize: '16px', color: '#666' }}>
          Tổng số hội đồng: <strong style={{ color: '#f37021' }}>{committees.length}</strong>
        </div>
        <button
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '16px' }}>
              <div>
                ...
                <div style={{ fontSize: '14px', color: '#666' }}>
                  Sinh viên: <strong>{committee.student}</strong> | 
                  Ngày bảo vệ: <strong style={{ color: '#f37021' }}>{committee.defenseDate}</strong>
                </div>
              </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
              <h2 style={{ margin: 0, fontSize: '24px', color: '#f37021', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <UserPlus size={28} />
                Tạo hội đồng bảo vệ
              </h2>
              <button
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setNewCommittee({...newCommittee, topic: e.target.value})}
                  style={{
                    width: '100%',
                    padding: '10px 12px',
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setNewCommittee({...newCommittee, student: e.target.value})}
                  style={{
                    width: '100%',
                    padding: '10px 12px',
                    border: '1px solid #ddd',
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setNewCommittee({...newCommittee, defenseDate: e.target.value})}
                  style={{
                    width: '100%',
                    padding: '10px 12px',
                    border: '1px solid #ddd',
              ...
              <div style={{ borderTop: '2px solid #f0f0f0', paddingTop: '16px', marginTop: '8px' }}>
                <h3 style={{ fontSize: '16px', color: '#333', marginBottom: '12px' }}>Thành viên hội đồng</h3>
                ...
                <div style={{ marginBottom: '12px' }}>
                  ...
                  <select
                    ...
                    onChange={(e) => setNewCommittee({...newCommittee, chairman: e.target.value})}
                    style={{
                      width: '100%',
                      padding: '10px 12px',
                      border: '1px solid #ddd',
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setNewCommittee({...newCommittee, member: e.target.value})}
                    style={{
                      width: '100%',
                      padding: '10px 12px',
                      border: '1px solid #ddd',
